...
entry3 = Entry(frame, width=25, textvariable=password, font="arial 15", bd=1, show="*")
entry3.place(x=150, y=150)

show_password_var = BooleanVar()
show_password_checkbox = Checkbutton(frame, text="Show Password", variable=show_password_var, command=show_hide_password)
show_password_checkbox.place(x=400, y=150)

Protect = Button(root, text="PROTECT PDF FILE", compound=LEFT, width=20, height=0, bg="#bfb9b9",
